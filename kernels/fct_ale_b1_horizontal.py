...
def generate_code(tuning_parameters):
    ...
    compute_block = \
        ...
        "fct_plus[nodeOne + level + <%OFFSET%>] = fct_plus[nodeOne + level + <%OFFSET%>] + <%FMAX%>(0.0, fct_adf_h_value);\n" \
        "fct_minus[nodeOne + level + <%OFFSET%>] = fct_minus[nodeOne + level + <%OFFSET%>] + <%FMIN%>(0.0, fct_adf_h_value);\n" \
        "fct_plus[nodeTwo + level + <%OFFSET%>] = fct_plus[nodeTwo + level + <%OFFSET%>] + <%FMAX%>(0.0, -fct_adf_h_value);\n" \
        "fct_minus[nodeTwo + level + <%OFFSET%>] = fct_minus[nodeTwo + level + <%OFFSET%>] + <%FMIN%>(0.0, -fct_adf_h_value);\n"
